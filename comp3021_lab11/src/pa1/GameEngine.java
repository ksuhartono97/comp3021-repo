...
public class GameEngine 
{
	...
	public void loadPlayersAndUnits(File filename) throws IOException
	{
...
//					gameMap.checkStartingLocation(id, locX, locY);
					...
					switch (type) {
						case "Archer":
							newUnit = new Archer(id, GameMap.TERRAIN_OUT_OF_BOUNDS, GameMap.TERRAIN_OUT_OF_BOUNDS);
							break;
						case "Cavalry":
							newUnit = new Cavalry(id, GameMap.TERRAIN_OUT_OF_BOUNDS, GameMap.TERRAIN_OUT_OF_BOUNDS);
							break;
						case "Infantry":
							newUnit = new Infantry(id, GameMap.TERRAIN_OUT_OF_BOUNDS, GameMap.TERRAIN_OUT_OF_BOUNDS);
							break;
						case "Pikeman":
							newUnit = new Pikeman(id, GameMap.TERRAIN_OUT_OF_BOUNDS, GameMap.TERRAIN_OUT_OF_BOUNDS);
							break;
						default:
